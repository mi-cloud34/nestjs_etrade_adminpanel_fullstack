      ...
      <TableContainer sx={{ maxHeight: 440 }}>
        <Table stickyHeader aria-label="sticky table">
          <TableHead>
            ...
            <TableCell align="right"style={{ minWidth:170 }} > Price</TableCell>
            <TableCell align="right"style={{ minWidth:170 }} > Category</TableCell>
            <TableCell align="right"style={{ minWidth:170 }} > Image</TableCell>
            <TableCell align="center"style={{ minWidth:170 }} > Action</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {data
